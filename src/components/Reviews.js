...
class Reviews extends React.Component {
  ...
  mapUsersToReview = () => {
    if (this.props.userType === "employer") {
      if (this.props.caregivers) {
        return this.props.caregivers.map((c) => (
          <option value={c.id}>
      ...
      return this.props.employers.map((e) => (
        <option value={e.id}>
  ...
  renderReviews(reviews) {
    return reviews.map((review, index) => {
      return (
        <Review key={index} review={review} handleDelete={this.handleDelete} />
      );
    });
  }

  render() {
    const { authoredReviews, reviewsAboutMe } = this.props;
    return (
      <Styles>
          ...
          <Accordion>
            ...
            <Card>
              ...
              <Accordion.Collapse eventKey="1">
                <Card.Body>
                  {authoredReviews && this.renderReviews(authoredReviews)}
                </Card.Body>
              </Accordion.Collapse>
            </Card>
            <Card>
              ...
              <Accordion.Collapse eventKey="2">
                <Card.Body>
                  {reviewsAboutMe && this.renderReviews(reviewsAboutMe)}
                </Card.Body>
              </Accordion.Collapse>
            </Card>
          </Accordion>
...
const mapDispatchToProps = (dispatch) => {
  return {
    createReview: (review) =>
      dispatch({ type: "ADD_REVIEW", newReview: review }),
    deleteReview: (review) =>
      dispatch({ type: "DELETE_REVIEW", deletedReview: review }),
  };
};
