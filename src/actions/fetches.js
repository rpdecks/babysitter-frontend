    ...
    fetch(`${API_ROOT}/app_status`, fetchObject)
      ...
      .then((appData) => {
        ...
        if (userType === "employer") {
          ...
          dispatch({
            type: "STORE_REVIEWS_ABOUT_ME",
            reviewsAboutMe: appData.caregiver_reviews,
          });
          dispatch({
            type: "STORE_CAREGIVERS",
          ...
          dispatch({
            type: "STORE_REVIEWS",
            authoredReviews: appData.caregiver_reviews,
          });
          dispatch({
            type: "STORE_REVIEWS_ABOUT_ME",
            reviewsAboutMe: appData.employer_reviews,
          });
          dispatch({ type: "STORE_EMPLOYERS", employers: appData.employers });
          dispatch({
            type: "STORE_AVAILABLE_JOBS",
            availableJobs: appData.available_jobs,
          });
          dispatch({
            type: "STORE_INTERESTED_JOBS",
